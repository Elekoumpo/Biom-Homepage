...
const HeroSection1 = () => {
  return (
      ...
      >
          <div className="absolute w-3/5 md:top-56 top-12 md:left-28 left-4">
              ...
              <p className=" mt-4 text-base text-light text-white leading-[28px] font-brandon font-normal text-[20px] md:w-1/3 w-full"
              ...
              <button className="md:w-44 w-32 h-10 mt-8 md:mt-8 bg-white font-extrabold hover:bg-hover-color text-dark-green rounded-md font-brandon " style={{ fontSize: '13px' }}>GET STARTED</button>
          </div>
      </div>
  );
};
